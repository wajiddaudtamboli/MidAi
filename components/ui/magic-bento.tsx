...
const DEFAULT_GLOW_COLOR = '13, 148, 136'; // Teal color for healthcare theme
const MOBILE_BREAKPOINT = 768;

const healthcareCardData = [
    {
        color: '#0A1628',
    ...
    },
    {
        ...
        description: 'Secure digital health data',
        label: 'Privacy First'
    },
    {
        color: '#0A1628',
    ...
    },
    {
        color: '#0A1628',
        title: 'Mental Health',
        description: 'Therapy & wellness programs',
        label: 'Wellbeing'
    }
];
...
const MagicBento = ({
    ...
    return (
        ...
        .bento-section {
          ...
          --white: hsl(0, 0%, 100%);
          --teal-primary: rgba(13, 148, 136, 1);
          --teal-glow: rgba(13, 148, 136, 0.2);
          --teal-border: rgba(13, 148, 136, 0.8);
        }
        ...
        .card--border-glow:hover {
          box-shadow: 0 4px 20px rgba(13, 148, 136, 0.3), 0 0 30px rgba(${glowColor}, 0.2);
        }
      ...
      `}</style>
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid gap-2">
                    {healthcareCardData.map((card, index) => {
